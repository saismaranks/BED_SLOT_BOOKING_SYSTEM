...
INSERT INTO `bookingpatient` (`id`, `uniqueid`, `bedtype`, `hcode`, `spo2`, `pname`, `pphone`, `paddress`) VALUES
...
INSERT INTO `user` (`id`, `uniqueid`, `email`, `dob`) VALUES
...
ALTER TABLE `bookingpatient`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniqueid` (`uniqueid`(20));
